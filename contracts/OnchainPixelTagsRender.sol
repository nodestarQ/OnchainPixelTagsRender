...
contract OnchainPixelTagsRender is Ownable {
    ...
    //Metadata Parts
    string private comb1 = '{"name": "Pixel Tag #';
    string private comb2 = '","description": "4443 On-Chain PixelTags given out for confirmed kills in the PixelRoyale BATTLE GAME. Collect the PixelTags for a chance to win 10% of the PixelRoyale prize pool!","external_url": "http://pixelroyale.xyz/","attributes": [{"trait_type": "Background","value": "';
    string private comb3 = '"},{"trait_type": "Base","value": "';
    ...
    string[19] moTrait = ["Smile", "Rabbit", "Frown", "Jeez", "Deez", "Grin", "Hungry", "Hillbilly", "Yikes", "Dumber", "Cigarette", "Puke", "Raw", "Tongue", "Surprised", "Powercry", "Stunned", "Chew", "Respirator"]; 
    ...
    function tokenURI(uint16 _index) public view virtual returns (string memory) {
        ...
        // ----- JSON ASSEMBLY ------//
        json = abi.encodePacked(json,comb2,backgroundColor);
        json = abi.encodePacked(json,comb3,trait1);
        ...
        img = abi.encodePacked(img, '<polygon points="5,1 5,2 4,2 4,3 3,3 3,4 3,13 4,13 4,14 5,14 5,15 11,15 11,14 12,14 12,13 13,13 13,3 12,3 12,2 11,2 11,1" fill="hsl(',basePrimeCol,')"/>'); // --> Add BASE LAYER 1 
        img = abi.encodePacked(img, '<polygon points="5,2 5,3 4,3 4,3 4,3 4,4 4,13 5,13 5,14 6,14 6,14 11,14 11,13 11,13 12,13 12,3 11,3 11,2 11,2" fill="hsl(',baseSecondCol,')"/>'); // --> Add BASE LAYER 1
        //MOUTH//
